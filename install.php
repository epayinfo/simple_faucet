...
function check_db() {
    ...
    $db = new DbConnector;
    $db_error = !($db -> check_connection());
    return (!$db_error);
}

if(!isset($_GET['step']) && !isset($_POST['dbname'])){
?>
	<div class="panel panel-primary">
        <div class="panel-heading">Faucet Installer
        </div>
        <div class="panel-body">
          Hi
          <br>
          Thank you for using this installer to begin a your new faucet with 
          <a href="http://epay.info" target="_blank">ePay.info
          </a> 
          <br>
          We aim to improve the quality of this script over time, so remember to check the repository 
          <a href="https://github.com/epayinfo/simple_faucet" target="_blank">here
          </a> on regular basis to get the last updates.
          <br>
          Begin installing by clicking on the next step.
        </div>
        <div class="panel-footer">
          <a href="?step=2" class="btn btn-success pull-right">Next
          </a>
          <div class="clearfix">
          </div>
        </div>
...
<?php
}elseif(!isset($_POST['dbname']) || !check_db()){
?>
      <div class="panel panel-primary">
        <div class="panel-heading">Faucet Installer - Database
        </div>
...
<?php } ?>   
            <div class="form-group">
              ...
              <small>The name of the database you want to run your faucet in.
              </small>
            </div>
            <div class="form-group">
              <label for="uname">Database Username
              </label>
              <input class="form-control" name="uname" type="text" size="25" placeholder="username" />
              <small>Your MySQL username.
              </small>
            </div>
            <div class="form-group">
              <label for="pwd">Database Password
              </label>
              <input class="form-control" name="pwd" type="text" size="25" placeholder="password" />
              <small>Your MySQL password.
              </small>
            </div>
            <div class="form-group">
              ...
              <small>You should be able to get this info from your web host, if 
                <code>localhost
                </code> does not work.
              </small>
            </div>
...
?>
      <div class="panel panel-primary">
        <div class="panel-heading">Faucet Installer - Finish
        </div>
        <div class="panel-body">
          ...
          <center>
            ...
            <strong>
              <code style="font-size:24px">
                <?php echo $_SESSION['info']['admin'];?>
              </code>
            </strong>
            <br>
            <br>
            <div class="col-md-4 col-md-push-4">
              <a href="adm" class="btn btn-success btn-block">Go to Administartion
              </a>
            </div>
          </center>
          <br>
          ...
          <strong>Make sure install.php and install.sql are deleted from you host.
            <br>
