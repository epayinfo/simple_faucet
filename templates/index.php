	...
	<div class="container-fluid">
		...
		<div class="col-md-7 main_area">
			...
			<Div class="row text-center" style="font-size:20px;"> Every
				...
				<?php echo $currency; ?><br> <strong>Your earnings goes directly to your <a href="http://epay.info/" target="_blank">ePay</a> account</strong> </Div>
			...
			<div class="row" style="margin-top:5px;">
				<div class="col-md-10 col-md-push-1">
					<div class="alert alert-success text-center"> <strong><?php echo $succ; ?></strong>
						<?php echo $currency; ?> was sent to <strong><a href="https://epay.info/check/<?php echo $wallet; ?>" target="_blank" style="color:#464646"> your ePay.info account</a></strong> </div>
				</div>
			</div>
			<?php } ?>
				...
				<form action="" method="post" id="frm_contain">
					...
					<div class="row" style="margin-top:5px;">
						<div class="col-xs-4 text-center col-xs-push-4">
							...
							<?php } else { ?><button type="submit" name="with" class="btn btn-lg btn-block btn-success" id="claim" <?php if($bwait){ ?>disabled data-time="<?php echo $bwait_time; ?>"<?php } ?> >Claim your prize NOW!!</button>
							<?php } ?>
							<?php }else{ ?> <button type="submit" name="step2" class="btn btn-lg btn-block btn-success" id="claim" <?php if($bwait){ ?> disabled data-time="<?php echo $bwait_time; ?>"<?php } ?> >Next Step</button>
							<?php } ?> </div>
					</div>
					<?php } ?>
					<?php if($anti_bot > 4){ ?>
